...
func (h *httpHandler) updateByID(ctx *fiber.Ctx) error {
	...
	plan, err := h.planSvc.UpdatePlan(c, id, models.UpdatePlanInput{
		Name:        req.Name,
		Description: req.Description,
		UpdatedBy:   req.UpdatedBy,
	})
	if err != nil {
		h.logger.Error("failed to update plan", zap.String("id", id), zap.Reflect("error", err))
